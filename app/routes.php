...
Route::get('/plan/{id}', 'EventsController@show');
...
Route::get('/plan/{id}/serve/{userid}', 'EventsController@showserve');
Route::post('/plan/{id}/serve/{userid}', 'EventsController@doserve');
